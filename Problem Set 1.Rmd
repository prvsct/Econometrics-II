...
The returns of a financial asset.
...
Because $Y_t$ is a weakly stationary process: $\mathbb{E}[(Y_t-\mu)(Y_{t-j}-\mu)] = \gamma_j$, for all $t$ and for all $j$. 

Let $s := t+j$. Then: $\gamma_s = \mathbb{E}[(Y_{s}-\mu)(Y_{s-j}-\mu)] = \mathbb{E}[(Y_{t+j}-\mu)(Y_t-\mu)] = \gamma_{-j}$.